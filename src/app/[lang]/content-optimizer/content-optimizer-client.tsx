...
export default function ContentOptimizerClientPage({ dictionary }: { dictionary: any }) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      setError(t.error || 'An error occurred while optimizing the content. Please try again.');
      console.error(e);
    } finally {
      setLoading(false);
    }
