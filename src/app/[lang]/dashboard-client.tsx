...
export default function DashboardClientPage({ dictionary }: { dictionary: any }) {
  const t = dictionary;
  ...
  const keywordData = [
    { name: t.keywordRankings['top1-3'], value: 15, fill: "var(--color-top)" },
    { name: t.keywordRankings['top4-10'], value: 45, fill: "var(--color-top)" },
    { name: t.keywordRankings['top11-20'], value: 80, fill: "var(--color-mid)" },
    { name: t.keywordRankings['top21-50'], value: 120, fill: "var(--color-low)" },
  ];
    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">{t.websiteScore}</CardTitle>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">{t.organicTraffic}</CardTitle>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">{t.keywordsInTop10}</CardTitle>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">{t.socialEngagement}</CardTitle>
      ...
      <Card className="md:col-span-2">
        <CardHeader>
          <CardTitle>{t.trafficOverview.title}</CardTitle>
      ...
      <Card className="md:col-span-2">
        <CardHeader>
          <CardTitle>{t.keywordRankings.title}</CardTitle>
          <CardDescription>{t.keywordRankings.description}</CardDescription>
        </CardHeader>
        <CardContent>
          <ChartContainer config={chartConfig} className="h-[250px] w-full">
      ...
      <Card className="lg:col-span-4">
        <CardHeader>
          <CardTitle>{t.topKeywords.title}</CardTitle>
        </CardHeader>
        <CardContent>
