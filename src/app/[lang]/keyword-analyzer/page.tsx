...
export default function KeywordAnalyzerPage({ params: { lang } }: { params: { lang: Locale } }) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      setError(dictionary?.keywordAnalyzer.error || 'An error occurred while analyzing the website. Please try again.');
      console.error(e);
    } finally {
      setLoading(false);
    }
  ...
  const t = dictionary.keywordAnalyzer;
