...
export default function SocialMediaGeneratorPage({ params: { lang } }: { params: { lang: Locale } }) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      setError(dictionary?.socialMediaGenerator.error || 'An error occurred while generating posts. Please try again.');
      console.error(e);
    } finally {
      setLoading(false);
    }
  ...
  const t = dictionary.socialMediaGenerator;
