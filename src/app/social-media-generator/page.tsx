    ...
    <div className="space-y-8">
      <Card className="max-w-3xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Provide some content from your website to generate engaging social media posts.
          </CardDescription>
        </CardHeader>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Paste a blog post, product description, or any other content here..."
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g., Funny, Informative" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
